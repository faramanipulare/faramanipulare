...
async def refresh_calendar_sources(date_from: str, date_to: str, update_global_cache: bool = True) -> List[dict]:
...
async def analyze_day(
    ...
    all_events = await refresh_calendar_sources(date, date, update_global_cache=False)
